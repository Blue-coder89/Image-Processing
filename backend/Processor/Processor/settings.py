...
SECRET_KEY = 'django-insecure-#2#u_zcc56wk-34thnzv$0k_pv(a4wsbj@6rpm@h8#k0*hin#l'
...
CORS_ORIGIN_WHITELIST = [  # added this line
    'http://localhost:3000', # Now this url has access to our API
]